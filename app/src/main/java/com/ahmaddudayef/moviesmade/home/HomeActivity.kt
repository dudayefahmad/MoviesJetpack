...
import com.ahmaddudayef.moviesmade.search.SearchActivity
import com.ahmaddudayef.moviesmade.setting.SettingsActivity
...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            override fun onQueryTextSubmit(query: String?): Boolean {
                ...
                intent.putExtra(SearchActivity().extraQuery, query)
    ...
    private fun navigateToFavoriteFeature() {
        val uri = Uri.parse("moviesmade://favorite")
